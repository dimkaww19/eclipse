...
table.insert(S.connections, RS.RenderStepped:Connect(function()
    ...
    if S.FOVCircle then
        pcall(function()
            ...
            S.FOVCircle.Visible = (cfg.Enabled or S._aimHeld) and cfg.ShowFOVCircle
        end)
    end
    local aimActive = cfg.Enabled or S._aimHeld
    if not aimActive then S.lockedTarget = nil return end
    if true then
